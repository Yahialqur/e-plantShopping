...
function ProductList() {
    ...
    // Get cart items and total quantity from Redux store
    ...
    const handlePlantsClick = (e) => {
        e.preventDefault();
        setShowCart(false); // Show plants when "Plants" is clicked
    };
            ...
            <div className="navbar">
                ...
                <div style={{ position: 'relative' }}>
                    ...
                    <div style={{ position: 'relative' }}>
                        ...
                        <span className="cart-count">{totalQuantity}</span> {/* Show total quantity in the cart */}
                    </div>
                </div>
            </div>
            {!showCart ? (
